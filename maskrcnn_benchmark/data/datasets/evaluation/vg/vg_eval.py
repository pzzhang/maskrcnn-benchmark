...
def eval_detection_voc(pred_boxlists, gt_boxlists, classes, iou_thresh=0.5, eval_attributes=False, use_07_metric=False):
    ...
    for i, classname in enumerate(classes):
        ...
        rec, prec, ap, scores, npos = calc_detection_voc_prec_rec(pred_boxlists=pred_boxlists, gt_boxlists=gt_boxlists,\
                                        classindex=i, iou_thresh=iou_thresh, eval_attributes=eval_attributes, use_07_metric=use_07_metric)
...
def calc_detection_voc_prec_rec(pred_boxlists, gt_boxlists, classindex, iou_thresh=0.5, eval_attributes=False, use_07_metric=False):
